...
if(isset($_POST['course_submit']) && $_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    echo $course_subtitle = $_POST['course_subtitle'];
    echo $course_language = $_POST['course_language'];
    echo $selected_option = $_POST['selected_option'];
    echo $course_level = $_POST['course_level'];
    echo $course_taught = $_POST['course_taught'];

    echo $selected_course_type = isset($_POST['course_type']) ? $_POST['course_type'] : '';

    $image = $_FILES['course_image'];
    print_r($imgArray = imagehandling($image));
    print_r($imgArray['imgPath']);

    $course_video = $_FILES['course_video'];
    print_r($video = imagehandling($course_video));
            ...
            <div id="content-wrapper" class="d-flex flex-column container">
                ...
                <div id="content">
                                ...
                                <div class="row d-flex justify-content-between">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card-body mt-5">
                                            ...
                                            <input type="file" id="fileName" name="course_image" value="" accept=".png, .jpeg, .jpg">
                    ...
                    <label class="form-label">
                        ...
                        <button type="submit" style="background-color:black" id="submitBtn" disabled class="btn text-light mt-3 mb-5 fw-bold" name="course_submit">Submit & Next</button>
                     </div>
                    <!-- /.container-fluid -->
                </form>
