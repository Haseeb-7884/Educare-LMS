...
if(isset($_POST['requirements_submit']) && $_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    //   echo !empty($course_requirments) ? $course_requirments:'no requirements';
    $short_description = $_POST['short_description'];
    //   echo !empty($short_description) ? $short_description:'no description';
    $course_outcomes = $_POST['course_outcomes'];
    //   echo !empty($course_outcomes) ? $course_outcomes:'no outcomes';
    echo $course_includes = $_POST['course_includes'];
    //   echo !empty($course_includes) ? $course_includes:'no includes';
    $course_specifications = $_POST['course_specifications'];
    //   echo !empty($course_specifications) ? $course_specifications:'no specifications';
    echo $coruse_id = $_POST['coruse_id'];

       
    $course_detail = new backend();
    

    $get_course = $course_detail->update('course_requirments',array('course_requirments'=>$course_requirments,
    'short_description'=>$short_description,
    'course_outcome'=>$course_outcomes,
    'course_includes'=>$course_includes,
    'course_specifications'=>$course_specifications,
    'courses_id'=>$coruse_id),"courses_id = $coruse_id",null);
...
if (isset($_GET['courses_id'])) {
    ...
    foreach($get_course as $content_details){
        ...
        $get_course = $course_detail->fetching('course_requirments','*',null,"requirments_id ='$requirments_id'");
        if(!empty($get_course)){
            foreach($get_course as $AllRequirements){
                $course_requirments = $AllRequirements['course_requirments'];
                $short_description = $AllRequirements['short_description'];
                $course_outcome = $AllRequirements['course_outcome'];
                $course_includes = $AllRequirements['course_includes'];
                $course_specifications = $AllRequirements['course_specifications'];
            }
        }else{
            ...
            <div id="content-wrapper" class="d-flex flex-column container">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid mt-1">
                      ...
                      <form action="record-detail.php" id="textEditorForm" method="post" enctype="multipart/form-data">
                      ...
                      <div class="text-light p-3" style="background-color:#5a5c69;border-radius:5px;">
                            ...
                            <input type="hidden" value="<?= $courses_id ?>" placeholder="<?= $courses_id?>" name="coruse_id">
                            ...
                            <div class="mb-3 text-dark">
                                <label class="form-label">
                                    ...
                                    <div id="editor" class="editor editor1 p-3" contenteditable="true"
                                ...
                                <?= $course_requirments ?>
                                    ...
                                    <input type="hidden" id="editorContent" name="course_requirments">
                               ...
                               <i class="fa-solid fa-bold" style="color: #000205;"></i>
                                ...
                                <button type="button" class="btn fw-bold" onclick="createList('insertUnorderedList')">
                                    ...
                                    <div id="editor" class="editor editor2 editor_limit_1 p-3" contenteditable="true"
                                    style="height: 25vh; border: 1px solid black;overflow:scroll; margin-bottom:5px;">
                                <?=$short_description?>
                                </div>
                                    ...
                                    <input type="hidden" id="editorContent" name="short_description">
                            ...
                            <div class="mb-3 text-dark mt-5">
                                <label class="form-label">
                                    ...
                                    <div id="editor" class="editor3 editor editor_limit_0 p-3" contenteditable="true" 
                                    style="height: 25vh; border: 1px solid black;overflow:scroll; margin-bottom:5px;">
                                <?=$course_outcome?>
                                </div>
<div class="editor_limit_0_error error-message" style="color: red; display: none;">Please enter at least 7 points.</div>
                                    ...
                                    <input type="hidden" id="editorContent" name="course_outcomes">
                            ...
                            <div class="mb-3 text-dark mt-5">
                                <label class="form-label">
                                    ...
                                    <div id="editor" class="editor4 editor editor_limit_2 p-3" contenteditable="true" 
                                    style="height: 25vh; border: 1px solid black;overflow:scroll; margin-bottom:5px;">
                                <?=$course_includes?>
                                </div>
<div class="editor_limit_2_error error-message" style="color: red; display: none;">Please enter at least 5 points.</div>
                                    ...
                                    <input type="hidden" id="editorContent" name="course_includes">
                            ...
                            <div class="mb-3 text-dark mt-5">
                                <label class="form-label">
                                    ...
                                    <div id="editor" class="editor editor5 editor_limit_3 p-3" contenteditable="true">
                            ...
                            <div class="editor_limit_3_error error-message" style="color: red; display: none;">Please enter at least 12 points.</div>
                                    ...
                                    <input type="hidden" id="editorContent" name="course_specifications">
                        ...
                        <!-- <a href="updatations/index.php?courses_id=<?=$courses_id?>" class="btn bg-primary text-light fw-bold p-1 mt-4 mb-5 me-4">Update Previous</a> -->
