...
if(isset($_GET['submit'])){
  ...
  $announcement_content = $_GET['announcement_content'];
  $course_seclcted = $_GET['course_selected'];
  $announcement_date = $_GET['announcement_date'];
  
  $AddObj = new backend();

  $AddData =  $AddObj->insertion("instructor_announcements",array("announcement_title"=>$announcement_title,
  "announcement_content"=>$announcement_content,"announcement_date"=>$announcement_date,
  "courses_id"=>$course_seclcted
));

if($AddData){
  header("loation: communication_section.php");
}else{
  echo "Error Occurin in message sending";
}
...
<?php
 include("communication_section.php");
?>
