...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2024 at 01:59 PM
...
--
-- Table structure for table `assingmentquizzes`
--

CREATE TABLE `assingmentquizzes` (
  `Q$A` int(11) NOT NULL,
  `assingment_section_name` varchar(150) NOT NULL,
  `assingment_title` varchar(150) NOT NULL,
  `assingment_file` varchar(50) NOT NULL,
  `assingment_assesment` varchar(50) NOT NULL,
...
--
-- Dumping data for table `assingmentquizzes`
--

INSERT INTO `assingmentquizzes` (`Q$A`, `assingment_section_name`, `assingment_title`, `assingment_file`, `assingment_assesment`, `quiz_section_name`, `quiz_title`, `question1`, `1A`, `1B`, `1C`, `1D`, `question2`, `2A`, `2B`, `2C`, `2D`, `question3`, `3A`, `3B`, `3C`, `3D`, `question4`, `4A`, `4B`, `4C`, `4D`, `question5`, `5A`, `5B`, `5C`, `5D`, `question6`, `6A`, `6B`, `6C`, `6D`, `question7`, `7A`, `7B`, `7C`, `7D`, `question8`, `8A`, `8B`, `8C`, `8D`, `question9`, `9A`, `9B`, `9C`, `9D`, `question10`, `10A`, `10B`, `10C`, `10D`, `cources_id`, `requirments_id`, `section_id`) VALUES
(3, 'this is  a section', 'Assingment 01', 'Array', 'nthing here ti specil and more ', 'this is also a section', 'A quick quiz ', 'question1', 'a', 'b', 'c', 'd', 'this si 2nd question ', 'a', 'b', 'c', 'd', 'this is a 3rd question ', 'A', 'B', 'C', 'D', 'this is a 4rth question ', 'A', 'B', 'C', 'D', 'this is a 4rth question ', 'A', 'B', 'C', 'D', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 15, 22, 40);
...
--
-- Indexes for table `assingmentquizzes`
--
ALTER TABLE `assingmentquizzes`
  ADD PRIMARY KEY (`Q$A`),
...
--
-- AUTO_INCREMENT for table `assingmentquizzes`
--
ALTER TABLE `assingmentquizzes`
  MODIFY `Q$A` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `assingmentquizzes`
--
ALTER TABLE `assingmentquizzes`
