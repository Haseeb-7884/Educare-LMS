...
INSERT INTO `comments` (`comments_id`, `comment`, `courses_id`, `registration_id`) VALUES
(1, 'here there is the comment here only not the specific content that you are in search of so please choose your content specifially so that there is no any probem arise in the future ', 15, 1);
...
(1, 'AECPQ4', '10', '1', '2024-02-20', '8', '%', 1, 1, 15),
(2, 'Y8ZQ0S', '20', '5', '2024-03-19', '12', '%', 1, 1, 5);
...
(2, 'usman@gmail.com', 'usman', '$2y$10$M7OnI63aFKhy2R4XcG4lpOHClBIJVG8/1GnTnLaiORl2BDUa13k0m', 0),
(3, 'user@gmail.com', 'User000', '$2y$10$apD514YuKQNsBSS4khgcJOHRSVb2wsUSVfG5PooE6vMbABgg87SzC', 0),
...
--
ALTER TABLE `enrollments`
  MODIFY `enrollment_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
