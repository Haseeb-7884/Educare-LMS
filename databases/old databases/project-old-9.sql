...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2024 at 12:53 PM
...
(5, 'Busniess', 'categories/office_6879724.png'),
...
INSERT INTO `payments` (`payment_id`, `name`, `courses_id`, `emaill`, `stripe_token`, `registration_id`) VALUES
...
(4, 'user01@gmail.com', 'user01', '$2y$10$M.yMSLhHlFn9BhRuX5Ch/egkAydoQ2SaxQP614ZYTTgSCr.B.9ZzK');
...
--
ALTER TABLE `enrollments`
  MODIFY `enrollment_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
