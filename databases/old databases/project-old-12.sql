...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2024 at 04:15 PM
...
(1, 'AECPQ4', '10', '0', '2024-05-24', '1', '%', 1, 1, 15),
(2, 'Y8ZQ0S', '20', '3', '2024-05-26', '1', '%', 1, 1, 5);
...
(17, '', 'development with node js , node js development, node js with Javascript, Advance nodejs development and much more!', 'English', 'Beigner', 1, 'php development ', 'uploads/testimonial1-removebg-preview.png', 'uploads/testimonial1-removebg-preview.png', 'MUHAMMADUSMAN', 'When you click on the Bold, Italic, or Underline buttons, the selected text in the textarea will be formatted accordingly. The Bullet Point button will add a bullet point at the beginning of the current line or the selected text.<br><div><br></div><div>When you click on the Bold, Italic, or Underline buttons, the selected text in the textarea will be formatted accordingly. The Bullet Point button will add a bullet point at the beginning of the current line or the selected text.<br></div><div>When you click on the Bold, Italic, or Underline buttons, the selected text in the textarea will be formatted accordingly. The Bullet Point button will add a bullet point at the beginning of the current line or the selected text.<br></div><div>When you click on the Bold, Italic, or Underline buttons, the selected text in the textarea will be formatted accordingly. The Bullet Point button will add a bullet point at the beginning of the current line or the selected text.<br></div><div>When you click on the Bold, Italic, or Underline buttons, the selected text in the textarea will be formatted accordingly. The Bullet Point button will add a bullet point at the beginning of the current line or the selected text.<br></div><div>When you click on the Bold, Italic, or Underline buttons, the selected text in the textarea will be formatted accordingly. The Bullet Point button will add a bullet point at the beginning of the current line or the selected text.<br></div>', 1, 'Free');
...
(34, '', '', '', 'iframe1A', '', '', 'iframe1B', '', '', 'iframe1C', '', '', 'iframe1D', '', '', '', 'iframe2A', '', '', 'iframe2B', '', '', 'iframe2C', '', '', 'iframe2D', '', '', '', 'iframe3A', '', '', 'iframe3B', '', '', 'iframe3C', '', '', 'iframe3D', '', '', '', 'iframe4A', '', '', 'iframe4B', '', '', 'iframe4C', '', '', 'iframe4D', '', '', '', 'iframe5A', '', '', 'iframe5B', '', '', 'iframe5C', '', '', 'iframe5D', 43, 17, 24);
...
(43, 'Introduction to Kali Linux', 'Network Security Assessment', 'Web Application Testing', 'Wireless Penetration Testing', 'Forensics and Incident Response', '', '', '', 17, 24);
...
--
ALTER TABLE `cource`
  MODIFY `courses_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `courses_lectures`
  MODIFY `lecture_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `course_prices`
  MODIFY `prices_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `course_requirments`
--
ALTER TABLE `course_requirments`
  MODIFY `requirments_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `course_sections`
--
ALTER TABLE `course_sections`
  MODIFY `section_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `enrollments`
--
ALTER TABLE `enrollments`
  MODIFY `enrollment_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
