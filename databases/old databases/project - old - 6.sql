...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2024 at 06:57 PM
...
INSERT INTO `coupons` (`coupons_id`, `coupon`, `coupon_percent`, `coupons_quantity`, `coupon_expiry`, `coupons_usage_limit`, `cou_percentage`, `user_id`, `instructor_id`) VALUES
(1, 'AECPQ4', '10', '1', '2024-02-20', '8', '%', 1, 1);
...
--
ALTER TABLE `coupons`
  MODIFY `coupons_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `enrollments`
  MODIFY `enrollment_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
