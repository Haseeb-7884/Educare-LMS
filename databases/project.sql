...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2024 at 07:47 PM
...
(2, 'The course is very ellboarated with hands-on exercises. The content is up-to-date and quiz after each section makes learning more fun.', 9, 4, '2024-06-17 16:09:22'),
(8, 'there is a 2nd comment here only ', 15, 2, '2024-05-09 16:07:05'),
(9, 'there is a 3rd comment here only ', 9, 3, '2024-05-17 16:11:02'),
...
(1, 'AECPQ4', '10', '1', '2024-06-24', '1', '%', 1, 1, 15),
(2, 'Y8ZQ0S', '20', '3', '2024-06-26', '1', '%', 1, 1, 5),
(3, 'HD45VA', '35', '4', '2024-06-18', '6', '%', 1, 1, 9);
...
(30, 'learn app development with us ', 'development with node js , node js development, node js with Javascript, Advance nodejs development and much more!', 'English', 'Beigner', 3, 'App development ', 'uploads/2 image.jpg', 'uploads/ video 4.mp4', 'Jhon Boee', 'there is the content here&nbsp;', 8, '');
...
(23, 'learn app development with us ', 1),
(24, 'learn app development with us ', 1),
(25, 'learn app development with us ', 1),
(26, 'learn app development with us ', 1);
...
(8, 'Emily', 'Jhons ', 'Instructor at Udemy ', '09292828299', 'uploads/second-person.jpg', 'http://localhost/PHP-OOP/PROJECT/instructor/dashboard/edit_profile.php', 'http://localhost/PHP-OOP/PROJECT/instructor/dashboard/edit_profile.php', 'http://localhost/PHP-OOP/PROJECT/instructor/dashboard/edit_profile.php', '', 'http://localhost/PHP-OOP/PROJECT/instructor/dashboard/edit_profile.php', '                                                                                                                                                To help learners learn more about you, your bio should reflect your Credibility, Empathy, Passion, and Personality. Your biography should have at least 50 words, links and coupon codes are not permitted.To help learners learn more about you, your bio should reflect your Credibility, Empathy, Passion, and Personality.                                                                                                                                                ', '                                                                                                                                                                                    To help learners learn more about you, your bio should reflect your Credibility, Empathy, Passion, and Personality. Your biography should have at least 50 words, links and coupon codes are not permitted.To help learners ', '                                                                                                                                                To help learners learn more about you, your bio should reflect your Credibility, Empathy, Passion, and Personality. Your biography should have at least 50 words, links and coupon codes are not permitted.To help learners learn more about you, your bio shoul', 27, 1);
...
(4, 'Thanks for making a profile. Your profile is under admin revision. After approval, you will be able to access the dashboard.', '2024-06-21 11:56:32'),
(5, 'Thanks for making a profile. Your profile is under admin revision. After approval, you will be able to access the dashboard.', '2024-06-21 19:25:42'),
(6, 'Thanks for making a profile. Your profile is under admin revision. After approval, you will be able to access the dashboard.', '2024-06-21 19:26:52');
...
(46, 'Muhammad Usman', 15, 'abc@gmail.com', 'tok_1PTkMBKE6ut2K9Rwrx8rtp6g', '', 27);
...
(10, 'hasan@gmail.com', 'hasani', '$2y$10$QoYpz1r7dFcFZRc3qqalcu8BCkcGsdUuSnw7fAbRZKhWo.ETUXeUi', 0),
(27, 'new@gmail.com', 'Osman123', '$2y$10$eOOlYQwLysk6kjUskZHrWeS0wjZd0PZHunC/xu8Y.2R1heoSCzxcq', 1);
...
(24, 'Jhon', 'Doe', '09292828299', 'uploads/login.png', 'http://localhost/PHP-OOP/PROJECT/instructor/dashboard/edit_profile.php', 'http://localhost/PHP-OOP/PROJECT/instructor/dashboard/edit_profile.php', 27);
...
(2, 'this is just the title ', 15, 'nothing to show here so be quite please ', 'courseCotent', 2, 6),
(3, 'this is just the title ', 15, 'there is the content goes here so dont be more worry about the thinking ', 'courseCotent', 7, 6),
(4, 'Just for overcomming ', 13, 'there is the content goes here so dont be more worry about the thinking ', 'courseCotent', 2, 1),
(5, 'this is just the title ', 15, 'there is no log messgae to show here so get out from here ', 'courseCotent', 3, 6);
...
--
ALTER TABLE `enrollments`
  MODIFY `enrollment_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `notifications_for_admins`
  MODIFY `notify_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
