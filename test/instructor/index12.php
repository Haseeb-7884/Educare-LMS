...
<script>
    ...
    function selectContentType(select) {
        ...
        if (contentType === "video") {
            contentContainer.innerHTML = '<label>Video URL:</label><input type="file">';
    ...
    function addQuizQuestion(button) {
        ...
        var questionHtml = `<div>
                                ...
                                <ul>
                                    <li>Option A: ${optionA} <span class="delete-option-button" onclick="deleteOption(this)">Delete</span></li>
                                    <li>Option B: ${optionB} <span class="delete-option-button" onclick="deleteOption(this)">Delete</span></li>
                                    <li>Option C: ${optionC} <span class="delete-option-button" onclick="deleteOption(this)">Delete</span></li>
                                    <li>Option D: ${optionD} <span class="delete-option-button" onclick="deleteOption(this)">Delete</span></li>
                                </ul>
                            </div>`;
