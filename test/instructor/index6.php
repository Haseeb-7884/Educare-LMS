...
<body>
    <form action="process_editor.php" method="post">
        ...
        <button type="button" onclick="createList('insertUnorderedList')">Bullet List</button>
        <button type="button" onclick="createList('insertOrderedList')">Numbered List</button>
